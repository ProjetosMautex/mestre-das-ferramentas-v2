...
import { articles } from '../data/articlesmartelete';

export const CategoryMartelete: React.FC = () => {
    ...
    <main className="flex-grow bg-gray-50">
      <section className="bg-[#1a1a1a] py-16 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white mb-4">Marteletes</h1>
