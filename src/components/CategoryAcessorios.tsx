...
import { articlesacessorios } from '../data/articlesacessorios';

export const CategoryAcessorios: React.FC = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 9;
  const [inputPage, setInputPage] = useState('');

  const filteredArticles = articlesacessorios;
    ...
    <main className="flex-grow bg-gray-50">
      <section className="bg-[#1a1a1a] py-16 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white mb-4">Acessórios para Ferramentas</h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Análises técnicas, guias de compra e dicas para os melhores acessórios do mercado.
          </p>
        </div>
      </section>
