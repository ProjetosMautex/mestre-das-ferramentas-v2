...
export const BunnerDoMeiomartelete: React.FC = () => {
        ...
        {/* Topo: Texto Curto */}
          <div className="w-full">
            <p className="text-base md:text-lg text-gray-700 font-medium max-w-2xl mx-auto mb-2 leading-relaxed whitespace-pre-line">
              ...
              <span className="text-gray-900 font-bold">Guia Grátis:</span> Aprenda a escolher o martelete ideal (e profissional) gastando pouco.
            </p>
          </div>
