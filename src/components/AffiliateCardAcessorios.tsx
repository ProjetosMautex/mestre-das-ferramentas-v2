...
interface Props {
  id?: ProductAcessoriosId;
  productId?: ProductAcessoriosId;
  compact?: boolean;
}

export const AffiliateCardAcessorios: React.FC<Props> = ({ id, productId, compact = false }) => {
  const targetId = id || productId;
  const product = targetId ? productsAcessorios[targetId] : undefined;
