...
export const HomeContent = () => {
  ...
  const highlights = articles.slice(0, 6);
        ...
        <section className="bg-[#F9F9F9] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
              O guia definitivo focado em ferramentas de furação e parafusamento. Reviews, comparativos e guias das melhores parafusadeiras e furadeiras do mercado.
            </p>
