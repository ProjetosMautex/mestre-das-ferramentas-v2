  ...
  const team = [
    {
      ...
      description: [
        "Sou o Murilo, fundador do Mestre das Ferramentas e especialista em SEO e criação de sites de nicho. Meu trabalho é desenvolver conteúdos estratégicos sobre ferramentas de furação e fixação (como furadeiras e parafusadeiras), ajudando profissionais, hobistas e empresas a encontrarem informações realmente úteis para o dia a dia.",
        ...
        "No Mestre das Ferramentas, sou responsável pela definição da estratégia de conteúdo, revisão técnica dos artigos e desenvolvimento da estrutura do site, garantindo materiais completos, objetivos e relevantes para quem busca informações confiáveis sobre parafusadeiras e furadeiras."
      ]
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="text-xl leading-relaxed font-medium">
              Aqui, nosso objetivo é ajudar entusiastas do faça-você-mesmo, profissionais de manutenção, marceneiros, mecânicos e apaixonados por ferramentas de furação e parafusamento a escolherem as parafusadeiras e furadeiras certas para cada necessidade.
            </p>
            <p>
              Se você procura furadeiras para uso em casa ou parafusadeiras profissionais de alto desempenho, este é o lugar certo. Estamos aqui para orientar você de forma prática, honesta e técnica — sem enrolação.
            </p>
            <div className="bg-gray-50 border-l-8 border-[#FFD700] p-8 rounded-r-xl italic shadow-sm text-gray-800">
              "Cada artigo do site é escrito com base em vivência real: especialistas que testam, comparam e utilizam furadeiras e parafusadeiras diariamente em diferentes contextos — seja em trabalhos domésticos, marcenaria, serralheria, oficinas mecânicas ou obras profissionais."
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#1a1a1a] text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid gap-10">
            {[
              { title: "Especialização Prática", desc: "Nossa equipe é formada por especialistas com sólida experiência prática e conhecimento técnico específico em parafusadeiras e furadeiras. Conhecemos as melhores opções do mercado no detalhe — tanto na teoria quanto no uso real." },
