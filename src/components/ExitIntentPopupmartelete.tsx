...
export const ExitIntentPopupmartelete: React.FC = () => {
      ...
      <div className="max-w-5xl mx-auto relative px-2">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 text-center lg:text-left">
          <p className="font-medium text-sm md:text-base">
            💰 <strong className="text-[#FFD700]">Segredo Revelado:</strong> Como ter um Martelete Profissional pelo preço de Hobby.
          </p>
