  ...
  const faqData = [
    {
      ...
      answer: [
        ...
        "�0 esse recurso que impede o parafuso de afundar no miolo do MDF, evitando prejuízos irreversíveis nas peças."
      ]
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-16">
            ...
            <section id="parafusadeira-black-decker-ld12" className="scroll-mt-24 pt-8 border-t border-gray-100">
              ...
              <div className="space-y-4 prose prose-lg text-gray-700 max-w-none">
                ...
                <p>�0 uma ferramenta honesta, compacta e excelente para a manutenção da casa.</p>
              </div>
            ...
            <section id="parafusadeira-bosch-gsr-1000" className="scroll-mt-24 pt-8 border-t border-gray-100">
              ...
              <div className="space-y-4 prose prose-lg text-gray-700 max-w-none">
                ...
                <p>�0 o casamento perfeito entre precisão e robustez para reparos caseiros.</p>
              </div>
          ...
          <section className="mt-20 pt-12 border-t border-gray-200">
            ...
            <div className="space-y-4 prose prose-lg max-w-none text-gray-700">
              ...
              <p>�0 por isso que os modelos alimentados por baterias modernas de íon de lítio reinam soberanos.</p>
              <p>Elas oferecem agilidade, leveza e a mobilidade indispensável para você entrar no vão estreito de armário ou parafusar corrediças por baixo de tampos sem tropeçar em fios.</p>
            </div>
          </section>
          ...
          {/* FAQ Section - FORMATADO COMO ACORDE�O EXPANS�VEL */}
          <section className="mt-16 bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-200">
            ...
            <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">Clique sobre cada pergunta abaixo para expandir a resposta e entender melhor os detalhes t�cnicos antes de comprar.</p>
          ...
          <section className="mt-12 bg-[#FFFBE6] p-8 rounded-xl border border-[#FFD700]/30">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>�0 essa sensibilidade que separa um trabalho amador de um serviço com acabamento de marcenaria profissional.</p>
            </div>
          </section>
