...
const oldTableRegex = /<div className=\"mb-16 max-w-\[800px\] mx-auto bg-slate-50 p-2.5 rounded-lg sm:p-5\">[\s\S]*?<\/table>\s*<\/div>/;
const newTableStr = \<div className=\"mb-16 max-w-[850px] mx-auto bg-slate-50 p-2.5 rounded-2xl sm:p-5 border border-slate-200 shadow-sm\">
...
const oldFaqRegex = /<section className=\"mt-16 space-y-8\">[\s\S]*?(?={[\s]*\/\* Tips \*\/})/;
